...
('670e8400-e29b-41d4-a716-446655440001', '670e8400-e29b-41d4-a716-446655440001', 'authenticated', 'service_role', 'admin@example.com', crypt('password123', gen_salt('bf')), current_timestamp, '', current_timestamp, '', current_timestamp, '', '', current_timestamp, current_timestamp, '{"provider":"email","providers":["email"],"role":"service_role"}'::jsonb, '{}'::jsonb, current_timestamp, current_timestamp),
('670e8400-e29b-41d4-a716-446655440002', '670e8400-e29b-41d4-a716-446655440002', 'authenticated', 'service_role', 'admin@kater.jp', crypt('password123', gen_salt('bf')), current_timestamp, '', current_timestamp, '', current_timestamp, '', '', current_timestamp, current_timestamp, '{"provider":"email","providers":["email"],"role":"service_role"}'::jsonb, '{}'::jsonb, current_timestamp, current_timestamp),
